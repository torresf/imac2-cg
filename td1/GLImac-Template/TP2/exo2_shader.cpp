...
int main(int argc, char** argv) {
	...
	std::string shaderNameVS = argv[1];
	std::string shaderNameFS = argv[2];

	FilePath applicationPath(argv[0]);
	Program program = loadProgram(applicationPath.dirPath() + "shaders/" + shaderNameVS,
	                              applicationPath.dirPath() + "shaders/" + shaderNameFS);
	program.use();
